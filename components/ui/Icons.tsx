...
export const SlidersIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <circle cx="8" cy="8" r="3" fill="currentColor" className="text-current"></circle>
    <line x1="4" y1="16" x2="20" y2="16"></line>
    <circle cx="16" cy="16" r="3" fill="currentColor" className="text-current"></circle>
  </svg>
);
...
export const BroomIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 3v9" />
    <path d="M17 12h-10l1.5 8h7l1.5-8z" />
    <path d="M7.5 16h9" />
  </svg>
);
